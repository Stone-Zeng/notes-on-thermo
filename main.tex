...
\geometry{left = 2.54 cm, right  = 2.54 cm, top  = 3.18 cm, bottom = 3.18 cm}
...
%\begingroup
%  \theoremstyle{empty}
%  \theorembodyfont{\rmfamily\fangsong}
%  \theoremsymbol{\ensuremath{\mdlgblksquare}} % U+25A0
%  \theoremprework{\leavevmode\hskip2em}
%  \newtheorem{proof}{}
%\endgroup

\newenvironment{proof}%
  {\par\mbox{}\par\small}{\par\mbox{}\par}
...
%\newcommand\cmark{cmark}%{\ding{51}}
%\newcommand\xmark{xmark}%{\ding{55}}
\newcommand\cmark{\symbol{"2714}}
\newcommand\xmark{\symbol{"2718}}

%\newcommand{\emphA}[1]{\textsf{#1}}
%\newcommand{\emphB}[1]{\textit{#1}}
...
\DeclareDocumentCommand\dbar{ o g d() }{ % Differential 'd'
...
%\newcommand\pp{\piup} %圆周率
%\newcommand\ee{\mathrm{e}} %自然对数基
%\newcommand\ii{\mathrm{i}} %虚数单位
%\newcommand\hb{\hbar} %约化Planck常数
\def\kB{k_{\symrm{B}}} %Boltzmann常数
\newcommand\pfs{\epsilon_0} %真空介电常数 Permittivity of Free Space
